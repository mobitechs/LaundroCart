...
class shopkeeper_Registration extends StatefulWidget {
  @override
  _shopkeeper_RegistrationState createState() =>
      _shopkeeper_RegistrationState();
}

class _shopkeeper_RegistrationState extends State<shopkeeper_Registration> {
  String name = "",
      shopName = "",
      mobile = "",
      email = "",
  ...
  Future<void> _registerButton() async {
    ...
    longitude = first.coordinates.longitude.toString();
      ...
      if (name == "") {
        ...
        CommonMethods.showColoredToast("Please enter shopName", Colors.red);
      } else if (mobile == "") {
        ...
        CommonMethods.showColoredToast(
            "Enter enter password.", Colors.red);
      } else if (address == "") {
  ...
  callAPI() async {
    ...
    String bodyObj =
        '{"method":"userRegister","name":"$name","shopName":"$shopName","mobile":"$mobile","email":"$email","address":"$address","password":"$password","pinCode":"$pinCode","latitude":"$latitude","longitude":"$longitude", "userType":"Shopkeeper"}';
    ...
    if (data["Response"] == 'REGISTRATION_FAILED') {
      //login failed
      print('Shopkeeper Register Error');
      ...
      print('Shopkeeper Register successs');
      ...
      Navigator.pushAndRemoveUntil(
        context,
        MaterialPageRoute(builder: (BuildContext context) => Shopkeeper_Dashboard()),
        ModalRoute.withName('/'),
      );
    }
    loadProgress(false);
