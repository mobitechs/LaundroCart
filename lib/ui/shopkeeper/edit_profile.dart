...
class Edit_Shopkeeper_Profile extends StatelessWidget {
  @override
...
class _Edit_Profile_ScreenState extends State<Edit_Profile_Screen> {
  ...
  getSharedPrefData() async {
    ...
    shopNameController = new TextEditingController(text: shopName);
  ...
  callAPI() async {
    ...
    String bodyObj =
          '{"method":"editProfileShopkeeper","userId":"$userId","name":"$name","shopName":"$shopName","mobile":"$mobile","email":"$email","address":"$address","password":"$password","pinCode":"$pinCode","latitude":"$latitude","longitude":"$longitude"}';
